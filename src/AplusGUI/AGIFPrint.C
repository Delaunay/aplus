...
unsigned long generateOrientation(A sym_)
{
    if (!QS(sym_) && (sym_->t == Et && sym_->n > 0 && QS(*sym_->p))) {
        ...
        if ((k = (MSP::PageOrientation)(long)GUIEnum.printEnumHashTable()->lookup(s)) >= 0 && (k == MSP::Portrait || k == MSP::Landscape))
            return k;
    }
    return 0;
}
...
static void s_printPageOrientation(A style_)
{
    ...
    if (k)
        MSWidgetOutput::displayPrint()->pageOrientation(k);
}
...
static void s_printDisOrientation(A style_)
{
    ...
    k = (MSP::PageOrientation)generateOrientation(style_);
    if (k)
        MSWidgetOutput::displayPrint()->disclaimer().orientation(k);
}
...
static void s_printPagesize(A sym_)
{
    if (!QS(sym_) && (sym_->t == Et && sym_->n > 0 && QS(*sym_->p))) {
        MSP::PageSize k;
        char* s = (char*)XS(sym_->p[0])->n;
        if ((k = (MSP::PageSize)(long)GUIEnum.pageSizeStringHashTable()->lookup(s)) >= 0 && (k >= MSP::Letter && k <= MSP::B)) {
...
static void s_printMode(A sym_)
{
    if (!QS(sym_) && (sym_->t == Et && sym_->n > 0 && QS(*sym_->p))) {
        MSP::PrintMode k;
        char* s = (char*)XS(sym_->p[0])->n;
        if ((k = (MSP::PrintMode)(long)GUIEnum.printEnumHashTable()->lookup(s)) >= 0 && (k >= MSP::Mono && k <= MSP::Reverse)) {
...
static void s_printOutputMode(A sym_)
{
    if (!QS(sym_) && (sym_->t == Et && sym_->n > 0 && QS(*sym_->p))) {
        MSP::OutputMode k;
        char* s = (char*)XS(sym_->p[0])->n;
        if ((k = (MSP::OutputMode)(long)GUIEnum.printEnumHashTable()->lookup(s)) >= 0 && (k >= MSP::PS && k <= MSP::PPM)) {
...
static void s_printDisclaimerStyle(A sym_)
{
    if (!QS(sym_) && (sym_->t == Et && sym_->n > 0 && QS(*sym_->p))) {
        ...
        char* s = (char*)XS(sym_->p[0])->n;
        if ((k = (MSP::DisclaimerStyle)(long)GUIEnum.printEnumHashTable()->lookup(s)) >= 0 && (k >= MSP::Text && k <= MSP::Box || k == MSP::NoDisclaimer)) {
...
static void s_printDisclaimerFont(Font id_)
{
    ...
    if (fn == 0 || *fn == 0)
        fn = MSDisplayServer::defaultDisplayServer()->fontName(MSDisplayServer::defaultDisplayServer()->defaultFont());
...
static Font g_printDisclaimerFont(void)
{
    ...
    if (fn == 0 || *fn == 0)
        return MSDisplayServer::defaultDisplayServer()->defaultFont();
...
static void s_printLeftMargin(A value_)
{
    if (!QS(value_) && value_->r == 0) {
        ...
        p.i = value_->p;
        if (value_->t == Ft)
            MSWidgetOutput::displayPrint()->leftMargin(p.f[0]);
        else
            MSWidgetOutput::displayPrint()->leftMargin((double)p.i[0]);
    }
}
static A g_printLeftMargin(void)
{
    A r = gf(MSWidgetOutput::displayPrint()->leftMargin());
    return r;
}
...
static void s_printRightMargin(A value_)
{
    if (!QS(value_) && value_->r == 0) {
        ...
        p.i = value_->p;
        if (value_->t == Ft)
            MSWidgetOutput::displayPrint()->rightMargin(p.f[0]);
        else
            MSWidgetOutput::displayPrint()->rightMargin((double)p.i[0]);
    }
}
static A g_printRightMargin(void)
{
    A r = gf(MSWidgetOutput::displayPrint()->rightMargin());
    return r;
}
...
static void s_printTopMargin(A value_)
{
    if (!QS(value_) && value_->r == 0) {
        ...
        p.i = value_->p;
        if (value_->t == Ft)
            MSWidgetOutput::displayPrint()->topMargin(p.f[0]);
        else
            MSWidgetOutput::displayPrint()->topMargin((double)p.i[0]);
    }
}
static A g_printTopMargin(void)
{
    A r = gf(MSWidgetOutput::displayPrint()->topMargin());
    return r;
}
...
static void s_printBottomMargin(A value_)
{
    if (!QS(value_) && value_->r == 0) {
        ...
        p.i = value_->p;
        if (value_->t == Ft)
            MSWidgetOutput::displayPrint()->bottomMargin(p.f[0]);
        else
            MSWidgetOutput::displayPrint()->bottomMargin((double)p.i[0]);
    }
}
static A g_printBottomMargin(void)
{
    A r = gf(MSWidgetOutput::displayPrint()->bottomMargin());
    return r;
}
...
static void s_printDisLeftMargin(A value_)
{
    if (!QS(value_) && value_->r == 0) {
        ...
        p.i = value_->p;
        if (value_->t == Ft)
            MSWidgetOutput::displayPrint()->disclaimer().leftMargin(p.f[0]);
        else
            MSWidgetOutput::displayPrint()->disclaimer().leftMargin((double)p.i[0]);
    }
}
static A g_printDisLeftMargin(void)
{
    A r = gf(MSWidgetOutput::displayPrint()->disclaimer().leftMargin());
    return r;
}
...
static void s_printDisRightMargin(A value_)
{
    if (!QS(value_) && value_->r == 0) {
        ...
        p.i = value_->p;
        if (value_->t == Ft)
            MSWidgetOutput::displayPrint()->disclaimer().rightMargin(p.f[0]);
        else
            MSWidgetOutput::displayPrint()->disclaimer().rightMargin((double)p.i[0]);
    }
}
static A g_printDisRightMargin(void)
{
    A r = gf(MSWidgetOutput::displayPrint()->disclaimer().rightMargin());
    return r;
}
...
static void s_printDisTopMargin(A value_)
{
    if (!QS(value_) && value_->r == 0) {
        ...
        p.i = value_->p;
        if (value_->t == Ft)
            MSWidgetOutput::displayPrint()->disclaimer().topMargin(p.f[0]);
        else
            MSWidgetOutput::displayPrint()->disclaimer().topMargin((double)p.i[0]);
    }
}
static A g_printDisTopMargin(void)
{
    A r = gf(MSWidgetOutput::displayPrint()->disclaimer().topMargin());
    return r;
}
...
static void s_printDisBottomMargin(A value_)
{
    if (!QS(value_) && value_->r == 0) {
        ...
        p.i = value_->p;
        if (value_->t == Ft)
            MSWidgetOutput::displayPrint()->disclaimer().bottomMargin(p.f[0]);
        else
            MSWidgetOutput::displayPrint()->disclaimer().bottomMargin((double)p.i[0]);
    }
}
static A g_printDisBottomMargin(void)
{
    A r = gf(MSWidgetOutput::displayPrint()->disclaimer().bottomMargin());
    return r;
}
