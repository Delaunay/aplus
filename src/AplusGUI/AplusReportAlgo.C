...
{
    if (_reportSum == 0)
        _reportSum = new AplusReportSumAlgorithm;
    return _reportSum;
}
...
{
    if (_reportMax == 0)
        _reportMax = new AplusReportMaxAlgorithm;
    return _reportMax;
}
...
{
    if (_reportMin == 0)
        _reportMin = new AplusReportMinAlgorithm;
    return _reportMin;
}
...
{
    if (_reportAvg == 0)
        _reportAvg = new AplusReportAvgAlgorithm;
    return _reportAvg;
}
...
{
    if (_reportStdDev == 0)
        _reportStdDev = new AplusReportStdDevAlgorithm;
...
AplusReportVarianceAlgorithm::~AplusReportVarianceAlgorithm(void)
{
    if (_reportVariance != 0)
        delete _reportVariance;
}
...
{
    if (_reportMedian == 0)
        _reportMedian = new AplusReportMedianAlgorithm;
