...
#define SliderMethodsMacro(AplusSliderType, Type)                                        \
    ...
    AplusFormatter AplusSliderType::_outFormat;                                          \
                                                                                         \
    AplusSliderType::AplusSliderType(MSWidget* owner_)                                   \
        : Type(owner_)                                                                   \
    {                                                                                    \
    }                                                                                    \
                                                                                         \
    ...
    {                                                                                    \
        if (event_.type() == AplusEvent::symbol()) {                                     \
            if (dbg_tmstk)                                                               \
                cout << "Received UpdateEvent in AplusSliderType" << endl;               \
            update(MSIndexVector::nullVector());                                         \
        }                                                                                \
        if (event_.type() == AplusVerifyEvent::symbol()) {                               \
            if (dbg_tmstk)                                                               \
                cout << "Received VerifyEvent in AplusSliderType" << endl;               \
                                                                                         \
    ...
    {                                                                                    \
        ...
        if (v) {                                                                         \
            ...
            if ((inFunc = AplusModel::getInFunc(v)) != 0)                                \
                ...
                r = defaultInFunc(v, str_);                                              \
            if (r != 0) {                                                                \
                if (aset((I)v, (I)r, 0, 0) == 0)                                         \
                    showError(qs);                                                       \
                else {                                                                   \
