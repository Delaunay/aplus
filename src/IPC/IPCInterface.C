...
#define SRVPTR(X, MSG)                           \
    AipcService* srvptr = lookupAnyHandle(X);    \
...
static C* getString(A aobj)
{
    ...
    if (Ct == aobj->t)
        z = (C*)aobj->p;
    else if (Et == aobj->t && 1 == aobj->n && QS(*aobj->p))
        z = XS(*aobj->p)->n;
    else
        z = (C*)0;
    return z;
...
static void Initialize(void)
{
    ...
    ProtocolList[idx++][0] = si("A");
    ProtocolList[idx][1] = 0;
    ProtocolList[idx++][0] = si("raw");
    ProtocolList[idx][1] = si("RAW");
    ProtocolList[idx++][0] = si("tick");
    ProtocolList[idx][1] = 0;
    ProtocolList[idx++][0] = si("stream");
    ProtocolList[idx][1] = 0;
    ProtocolList[idx++][0] = si("ipc");
    ProtocolList[idx][1] = 0;
    ProtocolList[idx++][0] = si("delta");
    ProtocolList[idx][1] = 0;
    ProtocolList[idx++][0] = si("string");
    ProtocolList[idx][1] = 0;
    ProtocolList[idx++][0] = si("simple");
    ProtocolList[idx][1] = 0;
...
I ipcListenNPP(A afunc, A aname, I port, A aprotocol)
{
    ...
    if (!serviceName || !protocolSym || !QF(afunc))
        return -1;
    ...
    switch (protocolidx) {
    case 0:
        nLstn = new pA_Listener(serviceName, port, afunc);
        break;
    case 1:
        nLstn = new pRaw_Listener(serviceName, port, afunc);
        break;
    case 4:
        nLstn = new pIpc_Listener(serviceName, port, afunc);
        break;
    case 6:
        nLstn = new pString_Listener(serviceName, port, afunc);
        break;
    case 7:
        nLstn = new pSimple_Listener(serviceName, port, afunc);
        break;
...
I ipcListenN(A afunc, A aname)
{
    ...
    switch (protocolidx) {
    case 0:
        nLstn = new pA_Listener(*ahpp, afunc);
        break;
    case 1:
        nLstn = new pRaw_Listener(*ahpp, afunc);
        break;
    case 4:
        nLstn = new pIpc_Listener(*ahpp, afunc);
        break;
    case 6:
        nLstn = new pString_Listener(*ahpp, afunc);
        break;
    case 7:
        nLstn = new pSimple_Listener(*ahpp, afunc);
        break;
    default: /* unknown protocol */
...
I ipcConnectNHPP(A afunc, A aname, A ahost, I port, A aprotocol)
{
    ...
    if (!serviceName || !hostName || !protocolSym || !QF(afunc))
        return -1;
    ...
    switch (protocolidx) {
    case 0:
        nSrv = new pA_Connection(serviceName, hostName, port, afunc);
        break;
    case 1:
        nSrv = new pRaw_Connection(serviceName, hostName, port, afunc);
        break;
    case 2:
        ...
        break;
    case 4:
        nSrv = new pIpc_Connection(serviceName, hostName, port, afunc);
        break;
    case 5:
        Warn("%t ipcConnectHPP: unsupported protocol:%s\n", protocolSym->n);
        return -1;
        break;
    case 6:
        nSrv = new pString_Connection(serviceName, hostName, port, afunc);
        break;
    case 7:
        nSrv = new pSimple_Connection(serviceName, hostName, port, afunc);
        break;
    default: /* unknown protocol */
...
I ipcConnectN(A afunc, A aname)
{
    ...
    switch (protocolidx) {
    case 0:
        nSrv = new pA_Connection(*ahpp, afunc);
        break;
    case 1:
        nSrv = new pRaw_Connection(*ahpp, afunc);
        break;
    case 4:
        nSrv = new pIpc_Connection(*ahpp, afunc);
        break;
    case 5: {
        Warn("%t ipcConnectHPP: unsupported protocol:%s\n", protocolSym->n);
        return -1;
    ...
    case 6:
        nSrv = new pString_Connection(*ahpp, afunc);
        break;
    case 7:
        nSrv = new pSimple_Connection(*ahpp, afunc);
        break;
    default: /* unknown protocol */
