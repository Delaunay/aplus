    ...
    case Left: {
        ...
        do {
            ...
            if (i < _topCount) {
                ...
                _top[i].x = temp;
                temp = _top[i].width;
                _top[i].width = _top[i].height;
                _top[i].height = temp;
            }
            if (i < _bottomCount) {
                temp = _bottom[i].y;
                _bottom[i].y = _bottom[i].x;
                _bottom[i].x = temp;
                temp = _bottom[i].width;
                _bottom[i].width = _bottom[i].height;
                _bottom[i].height = temp;
            }
            if (i < _centerCount) {
                temp = _center[i].y;
                _center[i].y = _center[i].x;
                _center[i].x = temp;
                temp = _center[i].width;
                _center[i].width = _center[i].height;
