    ...
    : _name(pName_)
{
    ...
    if (copyPixmapDataWithKey(buf) == MSFalse)
        create(pServer_, buf, bitmap_, w_, h_);
}
    ...
    : _name(pName_)
{
    ...
    if (copyPixmapDataWithKey(buf) == MSFalse)
        create(pServer_, buf, bitmap_, w_, h_, fg_, bg_);
}
    ...
    : _name(pName_)
{
    ...
    if (copyPixmapDataWithKey(buf) == MSFalse)
        create(pServer_, buf, bitmap_, w_, h_, fg, bg);
}
    ...
    : _name(pName_)
{
    ...
    sprintf(buf, "File_%s_%s_%d_%d", pName_, bitmapFile_,
        DefaultDepthOfScreen(pServer_->screen()), pServer_->display());
    if (copyPixmapDataWithKey(buf) == MSFalse)
        create(pServer_, buf, bitmapFile_);
}
    ...
    : _name(pName_)
{
    ...
    sprintf(buf, "File_%s_%s_%d_%d_%d_%d", pName_, bitmapFile_,
        fg_, bg_, DefaultDepthOfScreen(pServer_->screen()), pServer_->display());
    if (copyPixmapDataWithKey(buf) == MSFalse)
        create(pServer_, buf, bitmapFile_, fg_, bg_);
}
    ...
    : _name(pName_)
{
    ...
    sprintf(buf, "File_%s_%s_%d_%d_%d_%d", pName_, bitmapFile_,
        fg, bg, DefaultDepthOfScreen(pServer_->screen()), pServer_->display());
    if (copyPixmapDataWithKey(buf) == MSFalse)
        create(pServer_, buf, bitmapFile_, fg, bg);
}
    ...
    : _name(pName_)
{
    ...
    sprintf(buf, "Predefined_%s_%d_%d_%d_%d", pName_,
        fg_, bg_, DefaultDepthOfScreen(pServer_->screen()), pServer_->display());
    if (copyPixmapDataWithKey(buf) == MSFalse)
        create(pServer_, pName_, fg_, bg_);
}
    ...
    : _name(pName_)
{
    ...
    if (copyPixmapDataWithKey(buf) == MSFalse)
        create(pServer_, pName_, fg_, bg_, depth_);
}
    ...
    : _name(pName_)
{
    ...
    sprintf(buf, "General_%s_%d_%d_%d_%d_%d_%d", pName_, w_, h_,
        fg_, bg_, DefaultDepthOfScreen(pServer_->screen()), pServer_->display());
    if (copyPixmapDataWithKey(buf) == MSFalse)
        create(pServer_, buf, w_, h_, fg_, bg_);
}
    ...
    : _name(pName_)
{
    ...
    sprintf(buf, "General_%s_%d_%d_%d_%d_%d_%d", pName_, w_, h_,
        fg, bg, DefaultDepthOfScreen(pServer_->screen()), pServer_->display());
    if (copyPixmapDataWithKey(buf) == MSFalse)
        create(pServer_, buf, w_, h_, fg, bg);
}
...
MSPixmap::~MSPixmap(void)
{
    if (_pData != 0) {
        ...
        if (_pData->referenceCount() == 1) {
            ...
            if (clipMask() != 0 && clipMask() != pixmap())
                XFreePixmap(server()->display(), clipMask());
    ...
    const char* bitmapFile_, unsigned long fg_, unsigned long bg_)
{
    ...
    int res;
    if (bitmapFile_ == 0)
        res = MSXReadBitmapFromResource(display, window, _name, &w, &h, &bitmap);
    else
        res = MSXReadBitmapFromXbmFile(display, window, bitmapFile_, &w, &h, &bitmap, fg_, bg_, depth);
