...
MSStringVectorTraceSet::MSStringVectorTraceSet(MSGraph* owner_, const MSStringVector& legends_, const MSSymbol& tag_)
    : MSTraceSet(owner_, legends_, tag_)
{
    init();
}

MSStringVectorTraceSet::MSStringVectorTraceSet(MSGraph* owner_, MSStringVector& m_, const char* legends_, const MSSymbol& tag_)
    : MSTraceSet(owner_, legends_, tag_)
{
    init();
    model(m_);
...
MSStringVectorTraceSet::MSStringVectorTraceSet(MSGraph* owner_, MSStringVector& m_, const MSStringVector& legends_, const MSSymbol& tag_)
    : MSTraceSet(owner_, legends_, tag_)
{
    init();
    model(m_);
