...
{
    if (MSView::model() != 0)
        value().format(buffer_, format(), timeZone());
...
void MSTimeEntryField::generateInputMask(void)
{
    ...
    case MSTime::HoursMinutesSeconds:
        mask = "--:--:--";
        break;
    case MSTime::MonthDayYear:
        mask = "--/--/----";
        break;
    case MSTime::HoursMinutesSecondsSlash:
        mask = "--:--:-- --/--/--";
        break;
    case MSTime::HoursMinutesSecondsSlash4:
        mask = "--:--:-- --/--/----";
        break;
    default:
        mask = "";
