...
MSMutex MSBaseVector<Type, Allocator>::_operationsMutex;
template <class Type, class Allocator>
MSMutex MSBaseVectorOps<Type, Allocator>::_nullDataMutex;
#endif
...
template <class Type, class Allocator>
MSBaseVector<Type, Allocator>::MSBaseVector(unsigned int length_, int, int)
    : MSVector()
    , _blocked(MSFalse)
{
...
#else
template <class Type, class Allocator>
MSBaseVector<Type, Allocator>::MSBaseVector(unsigned int length_)
    : MSVector()
    , _blocked(MSFalse)
{
    _pImpl = new MSVectorImpl(&ops(), length_);
...
template <class Type, class Allocator>
MSBaseVector<Type, Allocator>::MSBaseVector(unsigned int length_, const Type& filler_)
    : MSVector()
    , _blocked(MSFalse)
{
...
template <class Type, class Allocator>
MSBaseVector<Type, Allocator>::MSBaseVector(const char* pString_, const char delimiter_)
    : MSVector()
    , _blocked(MSFalse)
{
    _pImpl = new MSVectorImpl(&ops());
...
template <class Type, class Allocator>
MSBaseVector<Type, Allocator>::MSBaseVector(MSTypeData<Type, Allocator>* pData_, unsigned int len_)
    : MSVector()
    , _blocked(MSFalse)
{
...
template <class Type, class Allocator>
MSBaseVector<Type, Allocator>::MSBaseVector(const Type* pElements_, unsigned int len_)
    : MSVector()
    , _blocked(MSFalse)
{
