...
MSBinaryVector::MSBinaryVector(unsigned int length_, unsigned char filler_)
    : MSVector()
{
...
MSBinaryVector::MSBinaryVector(const char* pString_)
    : MSVector()
{
    _pImpl = new MSVectorImpl(&ops());
...
MSBinaryVector::MSBinaryVector(MSVectorImpl* pImpl_)
    : MSVector()
    , _pImpl(pImpl_)
{
}

MSBinaryVector::MSBinaryVector(MSBinaryVector::Data* pData_, unsigned int len_)
    : MSVector()
{
    _pImpl = new MSVectorImpl(&ops(), (void*)pData_, len_);
}

MSBinaryVector::MSBinaryVector(const unsigned char* pElements_, unsigned int len_)
    : MSVector()
{
...
MSBinaryVector::Data::Data(unsigned int size_)
    : MSData(size_)
{
}
