...
template <class Type>
MSMutex MSBuiltinVector<Type>::_operationsMutex;
#endif
...
template <class Type>
MSBuiltinVector<Type>::MSBuiltinVector(unsigned int length_)
    : MSBaseVector<Type, MSAllocator<Type>>((MSVectorImpl*)0)
{
...
template <class Type>
MSBuiltinVector<Type>::MSBuiltinVector(MSBuiltinVectorImpl* pImpl_)
    : MSBaseVector<Type, MSAllocator<Type>>(pImpl_)
{
}

template <class Type>
MSBuiltinVector<Type>::MSBuiltinVector(const char* pString_)
    : MSBaseVector<Type, MSAllocator<Type>>((MSVectorImpl*)0)
{
    this->_pImpl = new MSBuiltinVectorImpl(&ops(), &ops());
...
MSBuiltinVectorOps<Type>::MSBuiltinVectorOps()
    : MSBaseVectorOps<Type, MSAllocator<Type>>()
