...
MSTypeVector<char>::MSTypeVector(unsigned int length_)
    : BuiltinVectorChar(length_)
{
}

MSTypeVector<char>::MSTypeVector(unsigned int length_, const char filler_)
    : BuiltinVectorChar(length_, filler_)
{
}

MSTypeVector<char>::MSTypeVector(const MSTypeVector<char>& vect_)
    : BuiltinVectorChar(vect_)
{
}

MSTypeVector<char>::MSTypeVector(const BuiltinVectorChar& vect_)
    : BuiltinVectorChar(vect_)
{
}

MSTypeVector<char>::MSTypeVector(const BaseVectorChar& vect_)
    : BuiltinVectorChar((BuiltinVectorChar&)vect_)
{
}

MSTypeVector<char>::MSTypeVector(const char* pString_)
    : BuiltinVectorChar(pString_)
{
}
