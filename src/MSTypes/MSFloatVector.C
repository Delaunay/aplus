...
MSTypeVector<double>::MSTypeVector(unsigned int length_)
    : BuiltinVectorDouble(length_)
{
}
...
MSTypeVector<double>::MSTypeVector(const MSTypeVector<double>& vect_)
    : BuiltinVectorDouble(vect_)
{
}

MSTypeVector<double>::MSTypeVector(const BuiltinVectorDouble& vect_)
    : BuiltinVectorDouble(vect_)
{
}
...
MSTypeVector<double>::MSTypeVector(const char* pString_)
    : BuiltinVectorDouble(pString_)
{
}
