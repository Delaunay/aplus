    ...
    MSIndexVector& index_, int mode_)
{
    ...
    default:
    case Total:
        return computeTotal(model_, index_);
    case Minimum:
        return computeMinimum(model_, index_);
    case Maximum:
        return computeMaximum(model_, index_);
    case Average:
        return computeAverage(model_, weights_, index_);
    }
}
