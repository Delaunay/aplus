...
MSTypeVector<int>::MSTypeVector(unsigned int length_)
    : BuiltinVectorInt(length_)
{
}
...
MSTypeVector<int>::MSTypeVector(const MSTypeVector<int>& vect_)
    : BuiltinVectorInt(vect_)
{
}

MSTypeVector<int>::MSTypeVector(const BuiltinVectorInt& vect_)
    : BuiltinVectorInt(vect_)
{
}
...
MSTypeVector<int>::MSTypeVector(const char* pString_)
    : BuiltinVectorInt(pString_)
{
}
