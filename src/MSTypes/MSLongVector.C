...
MSTypeVector<long>::MSTypeVector(unsigned int length_)
    : BuiltinVectorLong(length_)
{
}
...
MSTypeVector<long>::MSTypeVector(const MSTypeVector<long>& vect_)
    : BuiltinVectorLong(vect_)
{
}

MSTypeVector<long>::MSTypeVector(const BuiltinVectorLong& vect_)
    : BuiltinVectorLong(vect_)
{
}
...
MSTypeVector<long>::MSTypeVector(const char* pString_)
    : BuiltinVectorLong(pString_)
{
}
