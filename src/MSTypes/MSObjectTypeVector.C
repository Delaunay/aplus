...
MSObjectVector<Type>::MSObjectVector()
    : MSBaseVector<Type, MSVectorModelAllocator<Type>>()
{
}
...
template <class Type>
MSObjectVector<Type>::MSObjectVector(const MSObjectVector<Type>& vect_)
    : MSBaseVector<Type, MSVectorModelAllocator<Type>>(vect_)
{
}

template <class Type>
MSObjectVector<Type>::MSObjectVector(const MSBaseVector<Type, MSVectorModelAllocator<Type>>& vect_)
    : MSBaseVector<Type, MSVectorModelAllocator<Type>>(vect_)
{
}

template <class Type>
MSObjectVector<Type>::MSObjectVector(const char* pString_, const char delimiter_)
    : MSBaseVector<Type, MSVectorModelAllocator<Type>>(pString_, delimiter_)
{
}
