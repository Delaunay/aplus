...
MSSimpleString::MSSimpleString(const MSSimpleString& aString, const MSSimpleString& bString)
{
    ...
    if (length() > 0) {
        char* dp = _string;
        if (aString.length() > 0)
            fastcopy(aString.string(), dp, aString.length());
        if (bString.length() > 0)
            fastcopy(bString.string(), dp + aString.length(), bString.length());
    }
    _string[length()] = '\0';
}
...
MSSimpleString::MSSimpleString(const MSSimpleString& aString, const char* pString)
{
    ...
    if (length() > 0) {
        ...
        if (aString.length() > 0)
            fastcopy(aString.string(), dp, aString.length());
        if (slen > 0)
            fastcopy(pString, dp + aString.length(), slen);
    }
    _string[length()] = '\0';
}
...
MSSimpleString::MSSimpleString(const char* pString, const MSSimpleString& aString)
{
    ...
    if (length() > 0) {
        char* dp = _string;
        if (slen > 0)
            fastcopy(pString, dp, slen);
        if (aString.length() > 0)
            fastcopy(aString.string(), dp + slen, aString.length());
    }
    _string[length()] = '\0';
}
...
MSSimpleString::MSSimpleString(const MSSimpleString& aString, char aChar)
{
    ...
    _string = new char[length() + 1];
    if (aString.length() > 0)
        fastcopy(aString.string(), _string, aString.length());
...
MSSimpleString::MSSimpleString(char aChar, const MSSimpleString& aString)
{
    ...
    _string[0] = aChar;
    if (aString.length() > 0)
        fastcopy(aString.string(), _string + 1, aString.length());
    _string[length()] = '\0';
}
