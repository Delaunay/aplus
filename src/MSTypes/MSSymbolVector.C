...
{
    if (0)
        operator<<(cout, MSBaseVector<MSSymbol, MSAllocator<MSSymbol>>());
    return 0;
}
...
MSTypeVector<MSSymbol>::MSTypeVector()
    : MSBaseVector<MSSymbol, MSAllocator<MSSymbol>>()
{
}
...
MSTypeVector<MSSymbol>::MSTypeVector(const MSTypeVector<MSSymbol>& vect_)
    : MSBaseVector<MSSymbol, MSAllocator<MSSymbol>>(vect_)
{
}

MSTypeVector<MSSymbol>::MSTypeVector(const MSBaseVector<MSSymbol, MSAllocator<MSSymbol>>& vect_)
    : MSBaseVector<MSSymbol, MSAllocator<MSSymbol>>(vect_)
{
}

MSTypeVector<MSSymbol>::MSTypeVector(const char* pString_)
    : MSBaseVector<MSSymbol, MSAllocator<MSSymbol>>(pString_)
{
}
