...
#pragma instantiate MSTypeMatrix < unsigned long> operator+ (const MSTypeMatrix <unsigned long>&, const MSTypeMatrix <unsigned long>&)
#pragma instantiate MSTypeMatrix < unsigned long> operator- (const MSTypeMatrix <unsigned long>&, unsigned long)
#pragma instantiate MSTypeMatrix < unsigned long> operator- (const MSTypeMatrix <unsigned long>&, const MSTypeMatrix <unsigned long>&)
#pragma instantiate MSTypeMatrix < unsigned long> operator*(const MSTypeMatrix <unsigned long>&, unsigned long)
#pragma instantiate MSTypeMatrix < unsigned long> operator*(unsigned long, const MSTypeMatrix <unsigned long>&)
...
#pragma instantiate MSTypeMatrix < unsigned long> operator/ (const MSTypeMatrix <unsigned long>&, unsigned long)
#pragma instantiate MSTypeMatrix < unsigned long> operator/ (const MSTypeMatrix <unsigned long>&, const MSTypeMatrix <unsigned long>&)
#pragma instantiate MSTypeMatrix < unsigned long> operator+ (const MSTypeMatrix <unsigned long>&, const MSTypeVector <unsigned long>&)
#pragma instantiate MSTypeMatrix < unsigned long> operator- (const MSTypeMatrix <unsigned long>&, const MSTypeVector <unsigned long>&)
#pragma instantiate MSTypeMatrix < unsigned long> operator*(const MSTypeMatrix <unsigned long>&, \
    const MSTypeVector <unsigned long>&)
#pragma instantiate MSTypeMatrix < unsigned long> operator/ (const MSTypeMatrix <unsigned long>&, const MSTypeVector <unsigned long>&)
#pragma instantiate MSTypeMatrix < unsigned long> operator+ (const MSTypeVector <unsigned long>&, const MSTypeMatrix <unsigned long>&)
