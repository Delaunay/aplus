...
MSTypeVector<unsigned long>::MSTypeVector()
    : BuiltinVectorUnsignedLong()
{
}

MSTypeVector<unsigned long>::MSTypeVector(unsigned int length_)
    : BuiltinVectorUnsignedLong(length_)
{
}
...
MSTypeVector<unsigned long>::MSTypeVector(const char* pString_)
    : BuiltinVectorUnsignedLong(pString_)
{
}
