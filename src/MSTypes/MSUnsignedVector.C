...
MSTypeVector<unsigned int>::MSTypeVector()
    : BuiltinVectorUnsigned()
{
}

MSTypeVector<unsigned int>::MSTypeVector(unsigned int length_)
    : BuiltinVectorUnsigned(length_)
{
}
...
MSTypeVector<unsigned int>::MSTypeVector(const char* pString_)
    : BuiltinVectorUnsigned(pString_)
{
}
