...
MSVectorImpl::MSVectorImpl(MSVectorImplOps* pOperations_, unsigned int length_)
    : _pOperations(pOperations_)
    , _len(length_)
    , _pElements(pOperations_->allocate(length_, length_))
{
}
