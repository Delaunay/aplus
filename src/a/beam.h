...
#define isAObject(AObject) \
    ((AObject).t >= 0) && ((AObject).t <= Ct) && ((AObject).r >= 0) && ((AObject).r <= MAXR) && (((AObject).n > 0) || ((AObject).n == 0 && ((AObject).r >= 1))) && (((AObject).i > 0) || ((AObject).i == 0 && ((AObject).r >= 1))) && ((AObject).c == 0)
...
#define checkFileSize32(AObject) \
    (sizeof(A32) - sizeof(INT32) + Tt32((AObject).t, (AObject).i * TR32(AObject)) + ((AObject).t == 2))

#define checkFileSize64(AObject) \
    (sizeof(A64) - sizeof(INT64) + Tt64((AObject).t, (AObject).i * TR64(AObject)) + ((AObject).t == 2))
