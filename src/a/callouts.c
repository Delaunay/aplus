...
{
    if (NULL == dstFP) {
        H("WARNING: uninitialized dst called\n");
        R;
    }
    suppressFpeDomain = 1;
    nExternalFPE = 0;
    if (v_ != 0 && v_->attr != 0)
        (*dstFP)(v_);
    if (dbg_xfpe)
        (void)xfpechk("dst callout", nExternalFPE);
    suppressFpeDomain = 0;
}
...
{
    if (NULL == xfFP) {
        H("WARNING: uninitialized xf called\n");
        R 0;
    }
    suppressFpeDomain = 1;
    nExternalFPE = 0;
    (*xfFP)();
    if (dbg_xfpe)
        xfpechk("xf callout", nExternalFPE);
    suppressFpeDomain = 0;
    R - 1;
}
...
{
    if (NULL == xupFP) {
        H("WARNING: uninitialized xup called\n");
        R;
    }
    suppressFpeDomain = 1;
    nExternalFPE = 0;
    (*xupFP)(v, d, i, p, r, uf);
    if (dbg_xfpe)
        xfpechk("xup callout", nExternalFPE);
    suppressFpeDomain = 0;
}
...
I vfy(V v, A a)
{
    I z;
    if (NULL == vfyFP) {
        H("WARNING: uninitialized vfy called\n");
        R - 1;
    }
    suppressFpeDomain = 1;
    nExternalFPE = 0;
    z = (*vfyFP)(v, a);
    if (dbg_xfpe)
        xfpechk("vfy callout", nExternalFPE);
    suppressFpeDomain = 0;
    R z;
}
...
{
    if (NULL == disableFP) {
        H("WARNING: uninitialized disable called\n");
        R;
    }
    (*disableFP)();
}
...
{
    if (NULL == enableFP) {
        H("WARNING: uninitialized enable called\n");
        R;
    }
    (*enableFP)();
}
