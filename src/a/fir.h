...
#define SIZEOFITEM(t) (((Et == t) ? sizeof(A) : (It == t) ? sizeof(I) : (Ft == t) ? sizeof(F) : (Ct == t) ? sizeof(C) : (Xt <= t) ? sizeof(A) : sizeof(I)))
...
#define IsSymbol(aobj, idx, match) ( \
    (Et == (aobj)->t && QS((aobj)->p[idx]) && (NULL == match || match == MS(si(match)))))
